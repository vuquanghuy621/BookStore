...
function GenresList() {
  ...
  const handleCallApiDelete = async () => {
    try {
      await genreApi.delete(authorDelete._id);
      setShowModal(false);
  ...
  const handleSubmitAdd = async (e) => {
    ...
    try {
      ...
      const payload = { ...addAuthor, slug: toSlug(addAuthor.name) };
  ...
  const handleSubmitUpdate = async (e) => {
    ...
    try {
      setLoading(true);
      // ✅ đảm bảo slug luôn khớp name
      const payload = { ...selectedAuthor, slug: toSlug(selectedAuthor?.name) };
      await genreApi.update(selectedAuthor?._id, payload);
                ...
                <input
                  ...
                  onChange={(e) => {
                    ...
                    setSelectedAuthor((prev) => ({
                      ...prev,
                      name,
                      slug: toSlug(name), // ✅ name đổi -> slug đổi
                    }));
                  }}
                />
              </Col>
                      ...
                      <td>
                        <Button
                          ...
                          onClick={() => {
                            ...
                            setSelectedAuthor({ ...item, slug: toSlug(item?.name) });
